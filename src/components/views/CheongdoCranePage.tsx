      ...
      <section className="relative py-24 px-6">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">청도 크레인 서비스</h2>
            <div className="max-w-4xl mx-auto">
              <p
                className="font-paragraph text-secondary-foreground text-base text-center"
                dir="ltr">
                자연과 산업이 조화를 이루는 청도에서 다양한 현장의 특성과 요구사항을 정확히 파악하여 최적화된 맞춤형 솔루션을 제공합니다. 청도 크레인을 비롯해 화양·운문·금천 등 청도 전역의 현장 특성에 맞춘 전문 장비를 활용하여, 안전하고 효율적인 운송 서비스를 통해 고객의 성공적인 프로젝트 완수를 지원합니다.
              </p>
            </div>
          </motion.div>
        </div>
