      ...
      <section className="relative py-24 px-6">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">청도크레인 서비스</h2>
            <div className="max-w-4xl mx-auto">
              <p
                ...
                dir="ltr">
                대한카고크레인은 청도 전지역에서 크레인 및 카고크레인 서비스를 제공합니다.
              </p>
              <p
                ...
                dir="ltr">
                청도크레인, 청도카고크레인 작업은 안전과 신속함을 최우선으로 합니다. 화양, 각남, 각북, 풍각 등 청도 전지역에서 즉시 배차 가능합니다. 반나절·일·월 단위 임대 가능하며, 숙련 기사 즉시 출동으로 신뢰할 수 있는 서비스를 제공합니다.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="relative py-24 px-6 bg-dark-gray">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">청도 지역 서비스</h2>
            <p className="text-lg font-paragraph text-secondary-foreground mx-auto text-center">
              청도 전지역에서 신속하고 안전한 크레인 서비스를 제공합니다
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: '신속한 배차', description: '청도 전지역 즉시 배차 가능' },
              ...
              { title: '지역 특화', description: '화양, 각남, 각북, 풍각 등 모든 지역' },
      ...
      <section className="relative py-24 px-6 md:px-12 lg:px-20 bg-dark-gray">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">청도 작업 현장</h2>
            <p className="text-lg font-paragraph text-secondary-foreground">
              청도크레인의 다양한 작업 현장을 확인하세요
            </p>
          </motion.div>
      ...
      <section className="py-24 px-6 bg-dark-gray">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">청도크레인 문의</h2>
            <p className="text-lg font-paragraph text-secondary-foreground">
