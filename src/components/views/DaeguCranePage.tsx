      ...
      <section className="relative py-24 px-6">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">대구크레인 서비스</h2>
            <div className="max-w-4xl mx-auto">
              <p
                ...
                dir="ltr">
                대한카고크레인은 대구 전지역에서 크레인 및 카고크레인 서비스를 제공합니다.
              </p>
              <p
                ...
                dir="ltr">
                대구크레인, 대구카고크레인 서비스는 숙련된 기사들이 안전하게 작업을 진행합니다. 북구, 수성구, 달서구, 달성군 등 대구 전지역에서 신속히 배차합니다. 24시간 즉시 배차, 숙련 기사 상시 대기로 언제든 신뢰할 수 있는 서비스를 제공합니다.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="relative py-24 px-6 bg-dark-gray">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">대구 지역 서비스</h2>
            <p className="text-lg font-paragraph text-secondary-foreground mx-auto text-center">
              대구 전지역에서 신속하고 안전한 크레인 서비스를 제공합니다
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: '24시간 배차', description: '24시간 즉시 배차 가능' },
              { title: '숙련 기사', description: '경험 많은 전문 기사 상시 대기' },
              { title: '스카이차 전문', description: '스카이차 및 카고크레인 전문' },
              { title: '안전 작업', description: '안전을 최우선으로 하는 시스템' },
              { title: '지역 특화', description: '북구, 수성구, 달서구, 달성군 등' },
              { title: '신속 대응', description: '신속한 현장 대응' }
            ].map((feature, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
      ...
      <section className="relative py-24 px-6 md:px-12 lg:px-20 bg-dark-gray">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">대구 작업 현장</h2>
            <p className="text-lg font-paragraph text-secondary-foreground">
              대구크레인의 다양한 작업 현장을 확인하세요
            </p>
          </motion.div>
      ...
      <section className="py-24 px-6 bg-dark-gray">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">대구크레인 문의</h2>
            <p className="text-lg font-paragraph text-secondary-foreground">
