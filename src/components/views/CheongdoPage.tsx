...
export default function CheongdoPage() {
          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              <p
                ...
                dir="ltr">
                청도 크레인은 중량물, 산업 장비, 건설 자재 운송 전문 기업입니다.
              </p>
              <p
                ...
                dir="ltr">
                <span className="whitespace-nowrap sm:whitespace-normal">각 현장의 특성과 요구사항을 정확히 파악하여 최적화된</span> 맞춤형 솔루션을 제공하며, 청도 지역의 전문 장비를 활용한 안전하고 효율적인 운송 서비스를 통해 고객의 성공적인 프로젝트 완수를 지원합니다.
              </p>
            </div>
          </motion.div>
        </div>
