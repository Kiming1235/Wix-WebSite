...
const REGION_CONFIG = {
  ...
  customDescription: '산악 지형의 특성을 이해하고 다양한 현장의 특성과 요구사항을 정확히 파악하여 최적화된 맞춤형 솔루션을 제공합니다. 군위 크레인을 비롯해 의성·칠곡 등 군위 전역의 현장 특성에 맞춘 전문 장비를 활용하여, 안전하고 효율적인 운송 서비스를 통해 고객의 성공적인 프로젝트 완수를 지원합니다.',
  galleryImages: [
    {
