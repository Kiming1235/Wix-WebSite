      ...
      <section className="relative py-24 px-6">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">군위크레인 서비스</h2>
            <div className="max-w-4xl mx-auto">
              <p
                ...
                dir="ltr">
                대한카고크레인은 군위 전지역에서 크레인 및 카고크레인 서비스를 제공합니다.
              </p>
              <p
                ...
                dir="ltr">
                군위크레인, 군위카고크레인 작업은 현장 경험이 풍부한 기사들이 직접 배차합니다. 소보, 우보, 의흥 등 군위 전지역에서 즉시 출동 가능합니다. 안전하고 신뢰할 수 있는 서비스로 고객의 만족을 최우선으로 합니다.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="relative py-24 px-6 bg-dark-gray">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">군위 지역 서비스</h2>
            <p className="text-lg font-paragraph text-secondary-foreground mx-auto text-center">
              군위 전지역에서 신속하고 안전한 크레인 서비스를 제공합니다
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: '신속한 출동', description: '군위 전지역 즉시 출동 가능' },
              { title: '경험 많은 기사', description: '현장 경험이 풍부한 전문 기사' },
              { title: '신뢰할 수 있는 서비스', description: '안전하고 신뢰할 수 있는 작업' },
              { title: '전문 장비', description: '최신 크레인 및 카고크레인 보유' },
              { title: '지역 특화', description: '소보, 우보, 의흥 등 모든 지역' },
      ...
      <section className="relative py-24 px-6 md:px-12 lg:px-20 bg-dark-gray">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">군위 작업 현장</h2>
            <p className="text-lg font-paragraph text-secondary-foreground">
              군위크레인의 다양한 작업 현장을 확인하세요
            </p>
          </motion.div>
      ...
      <section className="py-24 px-6 bg-dark-gray">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">군위크레인 문의</h2>
            <p className="text-lg font-paragraph text-secondary-foreground">
