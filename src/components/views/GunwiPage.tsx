...
export default function DaeguPage({
  ...
  const galleryImages = [
    ...
    { src: 'https://static.wixstatic.com/media/6820d4_658942be47c843f09ee467b874a84f09~mv2.jpg', alt: '군위 크레인 작업 현장 3' },
    { src: 'https://static.wixstatic.com/media/6820d4_7d5912f902ed458a9ab081d1f54e1ba2~mv2.jpg', alt: '군위 크레인 작업 현장 4' },
    { src: 'https://static.wixstatic.com/media/6820d4_baa57dccb97142599f3a5ef455ba392a~mv2.jpg', alt: '군위 크레인 작업 현장 5' },
    { src: 'https://static.wixstatic.com/media/6820d4_226bebe0ea604698958b4f3ddf87daa7~mv2.jpg', alt: '군위 크레인 작업 현장 6' },
    { src: 'https://static.wixstatic.com/media/6820d4_d9967036235e430089fc18621661705e~mv2.jpg', alt: '군위 크레인 작업 현장 7' },
    { src: 'https://static.wixstatic.com/media/6820d4_5302d235bca14224979f68d0a4df5d05~mv2.jpg', alt: '군위 크레인 작업 현장 8' }
  ];
          ...
          >
            ...
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <p className="font-paragraph text-secondary-foreground text-lg leading-relaxed">
                {regionDescription ??
                  '군위 크레인은 도시 및 산업 밀집 지역의 다양한 현장에서 중량물 운송, 건설 자재 운반, 산업 장비 이전 등 맞춤형 솔루션을 제공하고 있습니다.'}
              </p>
            </div>
          </motion.div>
        </div>
