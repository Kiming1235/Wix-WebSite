...
interface GunwiPageProps {
  regionName?: string;
  regionDescription?: string;
}

export default function GunwiPage({ regionName = '군위', regionDescription }: GunwiPageProps) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-paragraph text-secondary-foreground text-lg leading-relaxed">
                    군위 크레인은 지역의 다양한 산업 현장에서 중량물 운송, 건설 자재 운반, 산업 장비 이전 등 맞춤형 솔루션을 제공하고 있습니다.
                  </p>
                </div>
              </motion.div>
            </div>
