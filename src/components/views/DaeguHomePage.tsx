...
export default function DaeguHomePage() {
  ...
  const regionConfig = {
    ...
    phone: '010-2332-4822',
    customDescription: '대구의 산업 중심지로서 다양한 현장의 특성과 요구사항을 정확히 파악하여 최적화된 맞춤형 솔루션을 제공합니다. 대구 크레인을 비롯해 중구·서구·남구·동구·북구·수성구·달서구 등 대구 전역의 현장 특성에 맞춘 전문 장비를 활용하여, 안전하고 효율적인 운송 서비스를 통해 고객의 성공적인 프로젝트 완수를 지원합니다.'
  };
      ...
      <section className="relative py-24 px-6">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">대구 크레인 서비스</h2>
            <div className="max-w-4xl mx-auto">
              <p
                className="font-paragraph text-secondary-foreground text-base text-center"
                dir="ltr">
                {regionConfig.customDescription}
              </p>
            </div>
          </motion.div>
        </div>
