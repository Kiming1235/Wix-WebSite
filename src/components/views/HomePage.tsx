        ...
        <div className="max-w-[100rem] mx-auto">
          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <p className="font-paragraph text-secondary-foreground text-base writing-mode-vertical-rl writing-mode-horizontal-tb [text-shadow:none] m-0 w-full my-0 mx-[100px]">
