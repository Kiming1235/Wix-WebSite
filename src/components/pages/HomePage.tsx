    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative h-[50vh] min-h-[400px] overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center z-10">
          <motion.h1
            className="text-7xl font-heading font-bold text-white mb-6 whitespace-nowrap"
        ...
        <div className="max-w-[100rem] mx-auto">
          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              <p
                className="font-paragraph text-secondary-foreground mb-6 text-lg writing-mode-vertical-rl writing-mode-horizontal-tb indent-0.5 normal-case not-italic no-underline text-center font-bold"
                dir="ltr">
