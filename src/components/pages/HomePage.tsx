        ...
        <div className="max-w-[100rem] mx-auto">
          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <p className="font-paragraph text-secondary-foreground text-base">{"각 현장의 특성과 요구사항을 정확히 파악하여 최적화된 맞춤형 솔루션을 제공하며, 안전하고 효율적인 운송 서비스를 통해 고객의 성공인 프로젝트 완수를 지원합니다."}</p>
            </div>
          </motion.div>
        </div>
        {/* Gradient transition to next section */}
